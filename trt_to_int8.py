...
def main():
    ...
    batchstream = calibrator_2.ImageBatchStream(
        5, calibration_files, sub_mean_chw)
    print("Map image data from float to int8...")
    int8_calibrator = calibrator_2.PythonEntropyCalibrator(["data"], batchstream)
    ...
    test_data = calibrator_2.ImageBatchStream.read_image_chw(TEST_IMAGE)
